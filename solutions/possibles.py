...
print("Welcome to Team 8's Sudoku Puzzle Solver. \nThis is the puzzle we will be solving today:")
print() # This is to print a blank line
...
def possible(y,x,n): #this will determine whether on a certain position we can put a number
    global problem
    for i in range (0,9):
        if problem[y][i] == n:
            return False
